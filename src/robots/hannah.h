...
create_hannah(Robot& robot)
{
    ...
    robot.connect_joint("lfsh", "lflu", .0, .0, +.5*leg_upper_len - fz, 'x', -90,  +90, -5, JointType::normal,    "L_shoulder_pitch"                    );
    robot.connect_joint("rfsh", "rflu", .0, .0, +.5*leg_upper_len - fz, 'x', -90,  +90, -5, JointType::symmetric, "R_shoulder_pitch", "L_shoulder_pitch");
    robot.connect_joint("lflu", "lfll", .0, -D, +.5*len_leg_lower + K , 'x',   0, +180, +15, JointType::normal,    "L_elbow_pitch"                       );
    robot.connect_joint("rflu", "rfll", .0, -D, +.5*len_leg_lower + K , 'x',   0, +180, +15, JointType::symmetric, "R_elbow_pitch"   , "L_elbow_pitch"   );
